 ...
 */
final class Version20180909105247 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figure CHANGE groupe_id category_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figure CHANGE category_id groupe_id INT NOT NULL');
    }
}
